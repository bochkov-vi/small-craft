...
public interface PersonRepository extends JpaRepository<Person, Long>, JpaSpecificationExecutor<Person> {
    ...
    default List<String> findFirstNameByMask(String pattern) {
        return findFirstNameByMask("%" + pattern + "%", pattern);
    }
    ...
    default List<String> findMiddleNameByMask(String pattern) {
        return findMiddleNameByMask("%" + pattern + "%", pattern);
    }
    ...
    default Page<Person> findByMask(String expr, Pageable pageable) {
        return findByMask(String.format("%%%s%%", expr), expr, pageable);
    }
}
