...
import com.bochkov.smallcraft.wicket.page.boat.SelectPier;
import com.bochkov.smallcraft.wicket.page.notification.SelectRegion;
...
public class FormComponentInputPanel extends FormComponentPanel<ExitNotification> {
    ...
    FormComponent<Boat> boat = new com.bochkov.smallcraft.wicket.page.boat.FormComponentInputPanel("boat", PersistableModel.of(id -> boatRepository.findById(id))) {
    ...
    FormComponent<Person> captain = new com.bochkov.smallcraft.wicket.page.person.FormComponentInputPanel("captain", PersistableModel.of(id -> personRepository.findById(id))).setCanSelect(true);
