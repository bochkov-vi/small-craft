package com.bochkov.smallcraft.wicket.page.store.legalPerson;
...
public class FormComponentInput extends FormComponentPanel<LegalPerson> {
    ...
    org.apache.wicket.markup.html.form.FormComponent<String> address = new TextArea<String>("address", Model.of()).setRequired(true);
